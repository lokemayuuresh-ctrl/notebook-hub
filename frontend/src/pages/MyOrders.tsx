...
const MyOrders = () => {
  const { user } = useAuth();
  const { getOrdersByBuyer, getUnreadNotifications, markNotificationRead, cancelOrder, orders: allOrders, refreshOrders } = useOrders();
                    ...
                    <div className="border-t border-border pt-4 mt-4">
                      ...
                      <PaymentButton
                        ...
                        onPaymentSuccess={async () => {
                          // Refresh orders in context instead of full page reload to avoid 404s
                          await refreshOrders();
                        }}
                      />
                    </div>
